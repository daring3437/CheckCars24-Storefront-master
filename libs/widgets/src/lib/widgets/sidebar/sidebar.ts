  ...
  template: `
    <div
      ...
      [ngClass]="{
        ...
        'p-sidebar-left': position === 'left',
        'p-sidebar-right': position === 'right',
        'p-sidebar-top': position === 'top',
        'p-sidebar-bottom': position === 'bottom',
        'p-sidebar-full': fullScreen
      }"
      [@panelState]="visible ? 'visible' : 'hidden'"
...
export class Sidebar
  implements AfterViewInit, AfterContentInit, AfterViewChecked, OnDestroy {
